              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Valor</label>
                    <input type="text" class="form-control" id="nombre" name = "Valor" placeholder="Valor">
                  </div>
                  <div class="form-group">
                    <label>Valor en letras</label>
                    <input type="text" class="form-control" id="Valor en letras" placeholder="Valor en letras">
                  </div>
                  <div class="form-group">
                    <label>Estado</label>
