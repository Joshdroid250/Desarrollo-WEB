...
$cap = $dtcp->obtenerRol($varIdCategoriaP);
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="../../negocio/ng_rol.php">
                ...
                <div class="form-group">
                    <label>ID</label>
                    <input type="text" value="<?php echo $cap->__GET('id_rol')?>" class="form-control" id="id_rol" name="id_rol" readonly required>
...
$("#id_rol").css("background-color", ":#black")
$("#rol_descripcion").val("<?php echo $cap-> __GET('rol_descripcion')?>");
