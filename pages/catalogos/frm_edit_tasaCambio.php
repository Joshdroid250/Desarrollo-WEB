...
$cap = $dtcp->obtenerTasaCambio($varIdCategoriaP);
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="../../negocio/ng_tasaCambio.php">
                ...
                <div class="form-group">
                    <label>ID</label>
                    <input type="text" value="<?php echo $cap->__GET('id_tasaCambio')?>" class="form-control" id="id_tasaCambio" name="id_tasaCambio" readonly required>
                    <input type="hidden" value="2" name="txtaccion" id="txtaccion"/>
                  </div>
                
                  <div class="form-group">
                    <label>Mes</label>
                    <input type="text" class="form-control" id="mes" name="mes" placeholder="Mes vigente" required>
                  </div>
                  <div class="form-group">
                    <label>Año</label>
                    <input type="number" class="form-control" id="anio" name="anio" placeholder="Año vigente" required>
                  </div>
                
                <div class="form-group">
                    <label>Estado</label>
                    <input type="number" class="form-control" id="estado" name="estado" placeholder="Estado" readonly required>
                  </div>
                </div>
            <!-- /.card -->
...
$("#id_tasaCambio").css("background-color", ":#black")
$("#id_monedaO").val("<?php echo $cap-> __GET('id_monedaO')?>");
$("#id_monedaC").val("<?php echo $cap-> __GET('id_monedaC')?>");
$("#mes").val("<?php echo $cap-> __GET('mes')?>");
$("#anio").val("<?php echo $cap-> __GET('anio')?>");
