                                ...
                                <form>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  value="<?php echo $opc->__GET('id_opciones'); ?>" class="form-control" id="id_opciones" name="id_opciones" placeholder="Codigo de Opcion" disabled required>
                                        </div>
                                        <div class="form-group">
                                            <label>Descripcion</label>
                                            <input type="text" value="<?php echo $opc->__GET('opcion_descripcion'); ?>" class="form-control" id="opcion_descripcion" name="opcion_descripcion" placeholder="Descripcion" disabled required>
                                        </div>
                                        <div class="form-group">
                                             <label>Estado</label>
                                             <input type="number" value="<?php echo $opc->__GET('estado'); ?>" class="form-control" id="estado" placeholder="Estado"disabled>
                                         </div>
                                    </div>
