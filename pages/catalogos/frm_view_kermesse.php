        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ver Item kermesse</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ver Item kermesse</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                ...
                <div class="card-footer">
                  ...
                  <a href="tbl_kermesse.php"><i class="far fa fa-undo-alt"></i>Regresar</a>
