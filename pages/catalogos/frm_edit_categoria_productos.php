          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar categoria de productos</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="../../negocio/ng_categoria_producto.php">
                ...
                <div class="form-group">
                    <label>ID</label>
                    <input type="text" value="<?php echo $cap->__GET('id_categoria_producto')?>" class="form-control" id="id_categoria_producto" name="id_categoria_producto" readonly required>
...
$("#id_categoria_producto").css("background-color", ":#black")
