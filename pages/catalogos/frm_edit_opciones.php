        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Editar Opciones</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form method="POST" action="../../negocio/ng_opciones.php"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" value="<?php echo $opc->__GET('id_opciones'); ?>" class="form-control" id="id_opciones" name="id_opciones"placeholder="Digite numero de opcion" readonly>
                    <input type="hidden" value="2" name="txtaccion" id="txtaccion"/>

                  </div>
                  <div class="form-group">
                    <label>Descripcion</label>
                    <input type="text" value="<?php echo $opc->__GET('opcion_descripcion'); ?>" class="form-control" id="opcion_descripcion" name="opcion_descripcion"placeholder="Ingrese la descripcion">
                  </div>
                </div>
                <!-- /.card-body -->
