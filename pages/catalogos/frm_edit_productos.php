              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="preciov_sugerido" placeholder="Precio sugerido">
                  </div>
                  
                  <div class="form-group">
                    <label>Categoria de producto</label>
                    <select name="nombre_categoria" id="id_categoria_gastos" >
                      <option value="">...</option>
